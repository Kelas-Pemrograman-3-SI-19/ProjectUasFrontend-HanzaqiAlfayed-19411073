        ...
        <q-list>
          <q-item class="justify-center text-center q-mb-md q-mt-md">
           <div>
            ...
            <div class="text-yellow">App Rental</div>
           </div>
          </q-item>
          ...
          <q-item clickable active-class="active" v-ripple exact :to="{ name: 'dashboardAdmin' }">
           ...
           <q-item clickable active-class="active" v-ripple exact :to="{ name: 'dataRental' }">
            <q-item-section avatar>
            <q-icon name="style"/>
            </q-item-section>
            <q-item-section>
            <q-item-label>Data Rental</q-item-label>
            </q-item-section>
          </q-item>
          <q-item clickable active-class="active" :to="{ name: 'inputBarang' }" v-ripple exact>
            ...
            <q-item-section>
            <q-item-label>Input Rental</q-item-label>
            </q-item-section>
          </q-item>
